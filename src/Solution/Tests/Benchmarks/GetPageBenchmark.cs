...
namespace Benchmarks
{
    ...
    public class GetPageBenchmark : BenchmarkBase
    {
        ...
        [Benchmark]
        public async Task GetPage_ContextPoolingDisableConcurrencyCheck()
        {
            await Do_GetPage(EfCoreContextPoolingNoConcurrencyCheckServiceProvider);
        }
        ...
        [Benchmark]
        public async Task GetPage_Dapper()
        {
            await Do_GetPage(DapperDefaultServiceProvider);
        }
